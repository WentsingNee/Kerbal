...
//
//				protected:
//					typedef kerbal::autonm::forward_list<pointer, kerbal::autonm::discard_deallocate_semi_allocator<pointer> > head_type;
...
//
//		template <typename T>
//		class pool_allocator: protected kerbal::memory::detail::pool_allocator_base
//		{
//			private:
