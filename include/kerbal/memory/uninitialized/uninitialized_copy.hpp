...
#ifndef KERBAL_MEMORY_UNINITIALIZED_UNINITIALIZED_COPY_HPP
#define KERBAL_MEMORY_UNINITIALIZED_UNINITIALIZED_COPY_HPP
...
#	if KERBAL_HAS_EXCEPTIONS_SUPPORT
			...
			typedef typename kerbal::type_traits::conditional<
					...
					kerbal::memory::detail::UI_CPY_VER_NO_CATCH,
					typename kerbal::type_traits::conditional<
						kerbal::memory::detail::can_be_nothrow_advance_iterator<iterator>::value,
						kerbal::memory::detail::UI_CPY_VER_NOTHROW_ITER_ADVANCE,
						kerbal::memory::detail::UI_CPY_VER_DEFAULT
					>::type
			>::type VER;

#	else

			typedef kerbal::memory::detail::UI_CPY_VER_NO_CATCH VER;

#	endif

			return kerbal::memory::detail::k_uninitialized_copy(first, last, to, VER());
		}
...
#endif // KERBAL_MEMORY_UNINITIALIZED_UNINITIALIZED_COPY_HPP
