...
#ifndef KERBAL_MEMORY_UNINITIALIZED_UNINITIALIZED_MOVE_HPP
#define KERBAL_MEMORY_UNINITIALIZED_UNINITIALIZED_MOVE_HPP
...
#	if KERBAL_HAS_EXCEPTIONS_SUPPORT
			...
			typedef typename kerbal::type_traits::conditional<
					...
					kerbal::memory::detail::UI_MOV_VER_NO_CATCH,
					typename kerbal::type_traits::conditional<
						kerbal::memory::detail::can_be_nothrow_advance_iterator<iterator>::value,
						kerbal::memory::detail::UI_MOV_VER_NOTHROW_ITER_ADVANCE,
						kerbal::memory::detail::UI_MOV_VER_DEFAULT
					>::type
			>::type VER;

#	else

			typedef kerbal::memory::detail::UI_MOV_VER_NO_CATCH VER;

#	endif

			return kerbal::memory::detail::k_uninitialized_move(first, last, to, VER());
		}
...
#endif // KERBAL_MEMORY_UNINITIALIZED_UNINITIALIZED_MOVE_HPP
