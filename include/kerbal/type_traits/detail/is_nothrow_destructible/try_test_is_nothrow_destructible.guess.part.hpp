/**
 * @file       try_test_is_nothrow_destructible.guess.part.hpp
 * @brief
 * @date       2023-05-03
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_DESTRUCTIBLE_TRY_TEST_IS_NOTHROW_DESTRUCTIBLE_GUESS_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_DESTRUCTIBLE_TRY_TEST_IS_NOTHROW_DESTRUCTIBLE_GUESS_PART_HPP

#if KERBAL_TYPE_TRAITS_DEBUG_WARNING
#	include <kerbal/config/compiler_id.hpp>

#	if KERBAL_COMPILER_ID == KERBAL_COMPILER_ID_MSVC
#		pragma message ("Kerbal Warning: " "try_test_is_nothrow_destructible is implemented under limited speculation mode")
#	else
#		warning "Kerbal Warning: " "try_test_is_nothrow_destructible is implemented under limited speculation mode"
#	endif
#endif
...
namespace kerbal
{
	...
	namespace type_traits
	{
		...
		namespace detail
		{
			...
			template <typename T>
			struct try_test_is_nothrow_destructible_helper :
		...
		struct try_test_is_nothrow_destructible :
			kerbal::type_traits::tribool_conjunction<
				...
				kerbal::type_traits::detail::try_test_is_nothrow_destructible_helper<
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_DESTRUCTIBLE_TRY_TEST_IS_NOTHROW_DESTRUCTIBLE_GUESS_PART_HPP
