/**
 * @file       try_test_is_nothrow_copy_assignable.guess.part.hpp
 * @brief
 * @date       2023-05-04
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_COPY_ASSIGNABLE_TRY_TEST_IS_NOTHROW_COPY_ASSIGNABLE_GUESS_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_COPY_ASSIGNABLE_TRY_TEST_IS_NOTHROW_COPY_ASSIGNABLE_GUESS_PART_HPP

#if KERBAL_TYPE_TRAITS_DEBUG_WARNING
#	include <kerbal/config/compiler_id.hpp>

#	if KERBAL_COMPILER_ID == KERBAL_COMPILER_ID_MSVC
#		pragma message ("Kerbal Warning: " "try_test_is_nothrow_copy_assignable is implemented under limited speculation mode")
#	else
#		warning "Kerbal Warning: " "try_test_is_nothrow_copy_assignable is implemented under limited speculation mode"
#	endif
#endif
...
namespace kerbal
{
	...
	namespace type_traits
	{
		...
		namespace detail
		{
			...
			template <typename T>
			struct try_test_is_nothrow_copy_assignable_helper :
		...
		struct try_test_is_nothrow_copy_assignable :
				kerbal::type_traits::conditional<
					...
					kerbal::type_traits::detail::try_test_is_nothrow_copy_assignable_helper<
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_COPY_ASSIGNABLE_TRY_TEST_IS_NOTHROW_COPY_ASSIGNABLE_GUESS_PART_HPP
