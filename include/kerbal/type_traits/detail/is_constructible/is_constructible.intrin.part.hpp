/**
 * @file       is_constructible.intrin.part.hpp
 * @brief
 * @date       2023-04-28
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_CONSTRUCTIBLE_IS_CONSTRUCTIBLE_INTRIN_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_CONSTRUCTIBLE_IS_CONSTRUCTIBLE_INTRIN_PART_HPP

#ifndef KERBAL_HAS_IS_CONSTRUCTIBLE_SUPPORT

#include <kerbal/type_traits/detail/compiler_intrinsics/compiler_intrinsics.hpp>

#if KERBAL_PRIVATE_HAS_INTRINSIC_IS_CONSTRUCTIBLE
	...
	namespace type_traits
	{
		...
		struct is_constructible :
			kerbal::type_traits::bool_constant<
				KERBAL_INTRINSIC_IS_CONSTRUCTIBLE(T, Args...)
			>
		{
		};
...
#	define TBODY(i) \
		...
		struct is_constructible<T KERBAL_OPT_PPEXPAND_WITH_COMMA_N(LEFT_JOIN_COMMA, EMPTY, TARGS_USE, i)> : \
			kerbal::type_traits::bool_constant< \
				KERBAL_INTRINSIC_IS_CONSTRUCTIBLE(T KERBAL_OPT_PPEXPAND_WITH_COMMA_N(LEFT_JOIN_COMMA, EMPTY, TARGS_USE, i)) \
			> \
		{ \
		}; \
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_CONSTRUCTIBLE_IS_CONSTRUCTIBLE_INTRIN_PART_HPP
