/**
 * @file       is_trivially_default_constructible.intrin.part.hpp
 * @brief
 * @date       2023-05-14
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE_INTRIN_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE_INTRIN_PART_HPP
...
#if KERBAL_PRIVATE_HAS_INTRINSIC_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE
		...
		struct is_trivially_default_constructible :
			kerbal::type_traits::conjunction<
				...
				kerbal::type_traits::bool_constant<
					KERBAL_INTRINSIC_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE(
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE_INTRIN_PART_HPP
