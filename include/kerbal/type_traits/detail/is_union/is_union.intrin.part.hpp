...
#if KERBAL_HAS_INTRINSIC_IS_UNION_SUPPORT
...
namespace kerbal
{
	...
	namespace type_traits
	{
		...
		template <typename T>
		struct is_union : kerbal::type_traits::bool_constant<KERBAL_INTRINSIC_IS_UNION(T)>
		{
		};
...
#endif // #if KERBAL_HAS_INTRINSIC_IS_UNION_SUPPORT
