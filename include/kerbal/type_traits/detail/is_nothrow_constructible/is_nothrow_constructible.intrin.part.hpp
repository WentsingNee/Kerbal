/**
 * @file       is_nothrow_constructible.intrin.part.hpp
 * @brief
 * @date       2023-05-03
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_IS_NOTHROW_CONSTRUCTIBLE_INTRIN_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_IS_NOTHROW_CONSTRUCTIBLE_INTRIN_PART_HPP
...
#if KERBAL_HAS_INTRINSIC_IS_NOTHROW_CONSTRUCTIBLE_SUPPORT
...
#endif // #if KERBAL_HAS_INTRINSIC_IS_NOTHROW_CONSTRUCTIBLE_SUPPORT

#endif // #ifndef KERBAL_HAS_IS_NOTHROW_CONSTRUCTIBLE_SUPPORT

#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_IS_NOTHROW_CONSTRUCTIBLE_INTRIN_PART_HPP
