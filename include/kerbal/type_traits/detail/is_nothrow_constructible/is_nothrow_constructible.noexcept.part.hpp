/**
 * @file       is_nothrow_constructible.noexcept.part.hpp
 * @brief
 * @date       2023-05-03
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_IS_NOTHROW_CONSTRUCTIBLE_NOEXCEPT_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_IS_NOTHROW_CONSTRUCTIBLE_NOEXCEPT_PART_HPP
...
#	define TBODY(i) \
		...
		struct is_nothrow_constructible<T KERBAL_OPT_PPEXPAND_WITH_COMMA_N(LEFT_JOIN_COMMA, EMPTY, TARGS_USE, i)> : \
				kerbal::type_traits::is_constructible< \
					T KERBAL_OPT_PPEXPAND_WITH_COMMA_N(LEFT_JOIN_COMMA, EMPTY, TARGS_USE, i) \
				> \
		{ \
		};
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_IS_NOTHROW_CONSTRUCTIBLE_NOEXCEPT_PART_HPP
