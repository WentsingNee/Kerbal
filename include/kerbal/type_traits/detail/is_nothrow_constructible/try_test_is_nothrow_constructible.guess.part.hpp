/**
 * @file       try_test_is_nothrow_constructible.guess.part.hpp
 * @brief
 * @date       2023-05-03
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_TRY_TEST_IS_NOTHROW_CONSTRUCTIBLE_GUESS_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_TRY_TEST_IS_NOTHROW_CONSTRUCTIBLE_GUESS_PART_HPP

#if KERBAL_TYPE_TRAITS_DEBUG_WARNING
#	include <kerbal/config/compiler_id.hpp>

#	if KERBAL_COMPILER_ID == KERBAL_COMPILER_ID_MSVC
#		pragma message ("Kerbal Warning: " "try_test_is_nothrow_constructible is implemented under limited speculation mode")
#	else
#		warning "Kerbal Warning: " "try_test_is_nothrow_constructible is implemented under limited speculation mode"
#	endif
#endif
...
#	if __cplusplus >= 201103L
		...
		struct try_test_is_nothrow_constructible :
...
#	define TBODY(i) \
		...
		struct try_test_is_nothrow_constructible<T KERBAL_OPT_PPEXPAND_WITH_COMMA_N(LEFT_JOIN_COMMA, EMPTY, TARGS_USE, i)> : \
				kerbal::type_traits::tribool_conjunction< \
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_NOTHROW_CONSTRUCTIBLE_TRY_TEST_IS_NOTHROW_CONSTRUCTIBLE_GUESS_PART_HPP
