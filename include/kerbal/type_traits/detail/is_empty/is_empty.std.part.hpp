...
#	else
#		warning "Kerbal Warning: " "can not detect the builtin is_empty function, <type_traits> header has been included"
#	endif
...
namespace kerbal
{
	...
	namespace type_traits
	{
		...
		template <typename T>
		struct is_empty : kerbal::type_traits::bool_constant<std::is_empty<T>::value>
		{
		};
