/**
 * @file       try_test_is_empty.guess.part.hpp
 * @brief
 * @date       2023-04-28
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_TYPE_TRAITS_DETAIL_IS_EMPTY_TRY_TEST_IS_EMPTY_GUESS_PART_HPP
#define KERBAL_TYPE_TRAITS_DETAIL_IS_EMPTY_TRY_TEST_IS_EMPTY_GUESS_PART_HPP

#if KERBAL_TYPE_TRAITS_DEBUG_WARNING
#	include <kerbal/config/compiler_id.hpp>

#	if KERBAL_COMPILER_ID == KERBAL_COMPILER_ID_MSVC
#		pragma message ("Kerbal Warning: " "try_test_is_empty is implemented under limited speculation mode")
#	else
#		warning "Kerbal Warning: " "try_test_is_empty is implemented under limited speculation mode"
#	endif
#endif
...
#endif // KERBAL_TYPE_TRAITS_DETAIL_IS_EMPTY_TRY_TEST_IS_EMPTY_GUESS_PART_HPP
