...
namespace kerbal
{
	...
	namespace smath
	{
		...
		namespace detail
		{
			...
			struct is_never_overflow_for_mul_mod_sa_smdispatch;

			// m != 0 && a % m != 0
			template <typename ResultType, ResultType a, ResultType m, typename Integer>
			struct is_never_overflow_for_mul_mod_sa_smdispatch<ResultType, a, m, Integer, 0> :
			...
			// m != 0 && a % m == 0
			template <typename ResultType, ResultType a, ResultType m, typename Integer>
			struct is_never_overflow_for_mul_mod_sa_smdispatch<ResultType, a, m, Integer, 1> :
			...
			// m == 0
			template <typename ResultType, ResultType a, ResultType m, typename Integer>
			struct is_never_overflow_for_mul_mod_sa_smdispatch<ResultType, a, m, Integer, 2> :
					kerbal::type_traits::bool_constant<
			...
			struct is_never_overflow_for_mul_mod :
					is_never_overflow_for_mul_mod_sa_smdispatch<
