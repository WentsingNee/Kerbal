...
namespace kerbal
{
	...
	namespace smath
	{
		...
		namespace detail
		{
			...
			struct multiply_mod_a_b_sm_impl<ResultType, m, false> // m != 0
			{
				private:
					...
					KERBAL_CONSTEXPR14
					static ResultType cacl_impl(ResultType a, ResultType b, kerbal::type_traits::type_identity<void>) KERBAL_NOEXCEPT
					{
						return cacl_impl2(a, b);
					}

					template <typename T>
					KERBAL_CONSTEXPR14
					static ResultType cacl_impl(ResultType a, ResultType b, kerbal::type_traits::type_identity<T>) KERBAL_NOEXCEPT
					{
				...
				public:
					...
					static ResultType cacl(ResultType a, ResultType b) KERBAL_NOEXCEPT
					{
						...
						return cacl_impl(a, b, kerbal::type_traits::type_identity<T>());
					}
			};
		...
		struct multiply_mod_a_b_sm
		{
				...
				static ResultType cacl(ResultType a, ResultType b) KERBAL_NOEXCEPT
				{
					return detail::multiply_mod_a_b_sm_impl<ResultType, m>::cacl(a, b);
				}
		};
