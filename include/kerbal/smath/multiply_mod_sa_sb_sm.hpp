...
namespace kerbal
{
	...
	namespace smath
	{
		...
		namespace detail
		{
			...
			template <typename ResultType, ResultType a, ResultType b, ResultType m, int = multiply_mod_sa_b_sm_selector<ResultType, a, m>::value>
			...
			template <typename ResultType, ResultType a, ResultType b, ResultType m, bool = (b <= kerbal::numeric::numeric_limits<ResultType>::MAX::value / a)>
