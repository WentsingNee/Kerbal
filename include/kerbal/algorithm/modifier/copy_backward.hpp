...
namespace kerbal
{
	...
	namespace algorithm
	{
		...
		namespace detail
		{
			...
			copy_backward_memmove_opt_dispatcher(
...
#		if KERBAL_HAS_IS_CONSTANT_EVALUATED_SUPPORT
			...
			return KERBAL_IS_CONSTANT_EVALUATED() ?
				kerbal::algorithm::detail::copy_backward_memmove_opt_dispatcher(first, last, to_last, kerbal::type_traits::false_type()) :
				kerbal::algorithm::detail::copy_backward_memmove_opt_dispatcher(first, last, to_last, is_memmove_optimizable());

#		else

			return kerbal::algorithm::detail::copy_backward_memmove_opt_dispatcher(first, last, to_last, kerbal::type_traits::false_type());

#		endif

#	else

			return kerbal::algorithm::detail::copy_backward_memmove_opt_dispatcher(first, last, to_last, is_memmove_optimizable());
