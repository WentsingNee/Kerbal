...
#		if KERBAL_HAS_IS_CONSTANT_EVALUATED_SUPPORT
			...
			return KERBAL_IS_CONSTANT_EVALUATED() ?
				kerbal::algorithm::detail::copy_memmove_opt_dispatcher(first, last, to, kerbal::type_traits::false_type()) :
				kerbal::algorithm::detail::copy_memmove_opt_dispatcher(first, last, to, is_memmove_optimizable());

#		else

			return kerbal::algorithm::detail::copy_memmove_opt_dispatcher(first, last, to, kerbal::type_traits::false_type());

#		endif

#	else

			return kerbal::algorithm::detail::copy_memmove_opt_dispatcher(first, last, to, is_memmove_optimizable());
