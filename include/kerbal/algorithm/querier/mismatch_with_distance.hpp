...
#include <kerbal/iterator/iterator>
...
namespace kerbal
{
	...
	namespace algorithm
	{
		...
		struct mismatch_with_distance_result_t
		{
				...
				KERBAL_CONSTEXPR
				mismatch_with_distance_result_t(InputIterator1 mismatch_point1, InputIterator2 mismatch_point2, std::size_t dist) :
						mismatch_point1(mismatch_point1), mismatch_point2(mismatch_point2), dist(dist)
				{
				}
		};
		...
		namespace detail
		{
			...
			_K_mismatch_with_distance(InputIterator1 first1, SentinelIterator1 last1, InputIterator2 first2, BinaryPredicate predicate, std::input_iterator_tag)
			{
				std::size_t dist = 0;
				while (first1 != last1) {
				...
				return mismatch_result_t<InputIterator1, InputIterator2>(first1, first2, dist);
			}

			template <typename InputIterator1, typename SentinelIterator1, typename InputIterator2, typename BinaryPredicate>
			KERBAL_CONSTEXPR14
			mismatch_with_distance_result_t<InputIterator1, InputIterator2>
			_K_mismatch_with_distance(InputIterator1 first1, SentinelIterator1 last1, InputIterator2 first2, BinaryPredicate predicate, std::random_access_iterator_tag)
			{
				...
				return mismatch_result_t<InputIterator1, InputIterator2>(it, first2, kerbal::iterator::distance(first1, it));
			}
		...
		KERBAL_CONSTEXPR14
		mismatch_with_distance_result_t<InputIterator1, InputIterator2>
		mismatch_with_distance(InputIterator1 first1, SentinelIterator1 last1, InputIterator2 first2, BinaryPredicate pred)
		{
			return kerbal::algorithm::detail::mismatch_with_distance(first1, last1, first2, pred, kerbal::iterator::iterator_category(first1));
		}
		...
		mismatch(InputIterator1 first1, SentinelIterator1 last1, InputIterator2 first2)
		{
			...
			typedef kerbal::algorithm::binary_type_equal_to<value_type1, value_type2> equal_to;
