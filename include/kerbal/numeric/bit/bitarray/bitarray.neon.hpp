...
#else
					uint8x8_t d_high = vcreate_u8(high * 0x0101010101010101ull);
					uint8x8_t d_low = vcreate_u8(low * 0x0101010101010101ull);
#endif
					uint8x16_t q_x = vcombine_u8(d_high, d_low);
					q_x = vandq_u8(q_x, q_andmask);
					q_x = vminq_u8(q_x, q_ALL_ONE);
