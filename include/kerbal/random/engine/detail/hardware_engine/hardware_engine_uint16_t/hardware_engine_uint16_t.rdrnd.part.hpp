...
#ifndef KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT16_T_HARDWARE_ENGINE_UINT16_T_RDRND_PART_HPP
#define KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT16_T_HARDWARE_ENGINE_UINT16_T_RDRND_PART_HPP
...
namespace kerbal
{
	...
	namespace random
	{
		...
		{
			private:
				typedef unsigned short						k_native_result_type;
...
#endif // KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT16_T_HARDWARE_ENGINE_UINT16_T_RDRND_PART_HPP
