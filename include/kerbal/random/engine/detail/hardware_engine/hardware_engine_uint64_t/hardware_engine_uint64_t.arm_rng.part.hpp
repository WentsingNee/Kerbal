...
#ifndef KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_ARM_RNG_PART_HPP
#define KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_ARM_RNG_PART_HPP
...
namespace kerbal
{
	...
	namespace random
	{
		...
		{
			private:
				typedef ::uint64_t							k_native_result_type;
...
#endif // KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_ARM_RNG_PART_HPP
