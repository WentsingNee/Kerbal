...
#ifndef KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_RDRND_PART_HPP
#define KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_RDRND_PART_HPP
...
namespace kerbal
{
	...
	namespace random
	{
		...
		{
			private:
				typedef unsigned long long					k_native_result_type;
...
#endif // KERBAL_RANDOM_ENGINE_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_RDRND_PART_HPP
