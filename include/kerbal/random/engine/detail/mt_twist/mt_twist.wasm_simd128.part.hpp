...
#ifndef KERBAL_RANDOM_ENGINE_DETAIL_MT_TWIST_MT_TWIST_WASM_SIMD128_PART_HPP
#define KERBAL_RANDOM_ENGINE_DETAIL_MT_TWIST_MT_TWIST_WASM_SIMD128_PART_HPP
...
//					const v128_t v128_ZERO = wasm_u32x4_const_splat(0);
					...
					for (; i + STEP::value <= NPM::value; i += STEP::value) {
						v128_t v128_mti = wasm_v128_load(reinterpret_cast<const v128_t*>(&mt[i]));
						v128_t v128_mtip1 = wasm_v128_load(reinterpret_cast<const v128_t*>(&mt[i + 1]));
...
//						v128_mag_mask = wasm_i32x4_sub(v128_ZERO, v128_mag_mask); // <=> wasm_i32x4_eq(v128_mag_mask, v128_ONE)
						...
						v128_t v128_mtipm = wasm_v128_load(reinterpret_cast<const v128_t*>(&mt[i + M]));
						v128_mti = wasm_v128_xor(v128_y, v128_mtipm);
						wasm_v128_store(reinterpret_cast<v128_t*>(&mt[i]), v128_mti);
					}

					typedef kerbal::type_traits::integral_constant<int, NPM::value % STEP::value> FIRST_STEP_REMAIN;
					if (FIRST_STEP_REMAIN::value == 3) {
//						v128_t v128_mti = _mm_loadl_epi64(reinterpret_cast<const v128_t*>(&mt[i]));
//						v128_t v128_mtip1 = _mm_loadl_epi64(reinterpret_cast<const v128_t*>(&mt[i + 1]));
//						v128_t v128_y = wasm_v128_bitselect(v128_mti, v128_mtip1, v128_UPPER_MASK);
//						v128_t v128_mag_mask = wasm_v128_and(v128_y, v128_ONE);
//						v128_mag_mask = wasm_i32x4_sub(v128_ZERO, v128_mag_mask); // <=> wasm_i32x4_eq(v128_mag_mask, v128_ONE)
//						v128_mag_mask = wasm_v128_and(v128_mag_mask, v128_A);
//						v128_y = wasm_u32x4_shr(v128_y, 1);
//						v128_y = wasm_v128_xor(v128_y, v128_mag_mask);
//						v128_t v128_mtipm = _mm_loadl_epi64(reinterpret_cast<const v128_t*>(&mt[i + M]));
//						v128_mti = wasm_v128_xor(v128_y, v128_mtipm);
//						_mm_storel_epi64(reinterpret_cast<v128_t*>(&mt[i]), v128_mti);
						EACH1(i);
						EACH1(i+1);
...
//						v128_mag_mask = wasm_i32x4_sub(v128_ZERO, v128_mag_mask); // <=> wasm_i32x4_eq(v128_mag_mask, v128_ONE)
						...
						v128_y = wasm_u32x4_shr(v128_y, 1);
						v128_y = wasm_v128_xor(v128_y, v128_mag_mask);
						v128_t v128_mtipm = wasm_v128_load(reinterpret_cast<const v128_t*>(&mt[i - (NPM::value)]));
						v128_mti = wasm_v128_xor(v128_y, v128_mtipm);
						wasm_v128_store(reinterpret_cast<v128_t*>(&mt[i]), v128_mti);
					}
...
//						v128_y = wasm_u32x4_shr(v128_y, 1);
//						v128_y = wasm_v128_xor(v128_y, v128_mag_mask);
//						v128_t v128_mtipm = _mm_loadl_epi64(reinterpret_cast<const v128_t*>(&mt[i - (NPM::value)]));
//						v128_mti = wasm_v128_xor(v128_y, v128_mtipm);
//						_mm_storel_epi64(reinterpret_cast<v128_t*>(&mt[i]), v128_mti);
						EACH2(i);
						EACH2(i+1);
...
#endif // KERBAL_RANDOM_ENGINE_DETAIL_MT_TWIST_MT_TWIST_WASM_SIMD128_PART_HPP
