...
#			define GENERATE_AVX2_U32() do { \
 ...
 \
				...
				template <
						...
						std::size_t U, kerbal::compatibility::uint32_t D, std::size_t S,
						kerbal::compatibility::uint32_t B, std::size_t T,
						kerbal::compatibility::uint32_t C, std::size_t L
				>
				void mt_twist_and_generate(kerbal::compatibility::uint32_t mt[], kerbal::compatibility::uint32_t out[]) KERBAL_NOEXCEPT
				{
...
#	endif
				...
				template <
						...
						std::size_t U, kerbal::compatibility::uint64_t D, std::size_t S,
						kerbal::compatibility::uint64_t B, std::size_t T,
						kerbal::compatibility::uint64_t C, std::size_t L
				>
				void mt_twist_and_generate(kerbal::compatibility::uint64_t mt[], kerbal::compatibility::uint64_t out[]) KERBAL_NOEXCEPT
				{
