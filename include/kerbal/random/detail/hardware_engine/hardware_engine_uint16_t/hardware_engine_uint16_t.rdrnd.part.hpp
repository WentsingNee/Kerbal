/**
 * @file       hardware_engine_uint16_t.rdrnd.part.hpp
 * @brief
 * @date       2024-04-04
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_RANDOM_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT16_T_HARDWARE_ENGINE_UINT16_T_RDRND_PART_HPP
#define KERBAL_RANDOM_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT16_T_HARDWARE_ENGINE_UINT16_T_RDRND_PART_HPP

#ifndef KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT16_T

#if __RDRND__
#	define KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT16_T 1
#else
...
#include <kerbal/random/hardware_engine/hardware_engine.fwd.hpp>
...
#include <kerbal/random/hardware_engine/hardware_engine_failure.hpp>
...
namespace kerbal
{
	...
	namespace random
	{
		...
		template <>
		class hardware_engine<kerbal::compatibility::uint16_t>
		{
			private:
				typedef kerbal::compatibility::uint16_t result_type;
...
#endif // #if KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT16_T

#endif // #ifndef KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT16_T

#endif // KERBAL_RANDOM_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT16_T_HARDWARE_ENGINE_UINT16_T_RDRND_PART_HPP
