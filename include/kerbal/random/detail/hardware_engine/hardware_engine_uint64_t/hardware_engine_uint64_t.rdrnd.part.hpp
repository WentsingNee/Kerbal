/**
 * @file       hardware_engine_uint64_t.rdrnd.part.hpp
 * @brief
 * @date       2024-04-04
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_RANDOM_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_RDRND_PART_HPP
#define KERBAL_RANDOM_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_RDRND_PART_HPP

#ifndef KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT64_T
...
namespace kerbal
{
	...
	namespace random
	{
		...
		template <>
		class hardware_engine<kerbal::compatibility::uint64_t>
		{
			private:
...
#endif // #if KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT64_T

#endif // #ifndef KERBAL_HAS_SUPPORT_OF_RANDOM_HARDWARE_ENGINE_UINT64_T

#endif // KERBAL_RANDOM_DETAIL_HARDWARE_ENGINE_HARDWARE_ENGINE_UINT64_T_HARDWARE_ENGINE_UINT64_T_RDRND_PART_HPP
