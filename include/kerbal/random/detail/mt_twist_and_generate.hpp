	...
	namespace random
	{
		...
		namespace detail
		{
			...
			template <
					...
					std::size_t U, UIntType D, std::size_t S,
					UIntType B, std::size_t T,
					UIntType C, std::size_t L
			>
			void mt_twist_and_generate_fix_integer_simd_dispatch(UIntType mt[N], UIntType * out, kerbal::type_traits::integral_constant<std::size_t, 32>) KERBAL_NOEXCEPT
			{
...
#		endif
			...
			template <
					...
					UIntType C, std::size_t L
			>
			void mt_twist_and_generate_fix_integer_simd_dispatch(UIntType mt[N], UIntType * out, kerbal::type_traits::integral_constant<std::size_t, 64>) KERBAL_NOEXCEPT
			{
...
#		endif
			...
			>
			KERBAL_CONSTEXPR14
			void mt_twist_and_generate_fix_integer_simd_dispatch(UIntType mt[N], UIntType * out, kerbal::type_traits::integral_constant<std::size_t, Size>) KERBAL_NOEXCEPT
			{
			...
			class mt_twist_and_generate_helper
			{
				protected:
					...
					{
						mt_twist_and_generate_fix_integer_simd_dispatch<UIntType, N, M, R, A>(mt, out, kerbal::type_traits::integral_constant<std::size_t, CHAR_BIT * sizeof(UIntType)>());
					}
