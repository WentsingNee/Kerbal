...
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 1 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 2 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 3 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 4 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 5 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 6 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
//						{
//							__m256i ymm_blockp0 = _mm256_loadu_si256(reinterpret_cast<const __m256i *>(&block[i + 7 * STEP::value])); // AVX
//							if (!_mm256_testc_si256(ymm_blockp0, ymm_ALL_ONE)) { // AVX
//								return false;
//							}
//						}
