...
#			define FBODY(i) \
				...
				const_iterator emplace(KERBAL_OPT_PPEXPAND_WITH_COMMA_N(REMAINF, EMPTY, ARGS_DECL, i)); \
...
#		if __cplusplus >= 201103L
				...
				template <typename ... Args>
				KERBAL_CONSTEXPR20
				const_iterator replace_emplace(const_iterator replace, Args && ... args);
...
#			define FBODY(i) \
				KERBAL_OPT_PPEXPAND_WITH_COMMA_N(THEAD_NOT_EMPTY, EMPTY, TARGS_DECL, i) \
				const_iterator replace_emplace(const_iterator replace KERBAL_OPT_PPEXPAND_WITH_COMMA_N(LEFT_JOIN_COMMA, EMPTY, ARGS_DECL, i)); \
...
#	endif // if __cplusplus >= 201703L
		...
		KERBAL_CONSTEXPR20
		bool operator==(
			const avl_multiset<T, KeyCompare, Allocator> & lhs,
			const avl_multiset<T, KeyCompare, Allocator2> & rhs
		)
		{
	...
	namespace algorithm
	{
		...
		KERBAL_CONSTEXPR20
		void swap(
			kerbal::container::avl_multiset<T, KeyCompare, Allocator> & a,
			kerbal::container::avl_multiset<T, KeyCompare, Allocator> & b
		)
