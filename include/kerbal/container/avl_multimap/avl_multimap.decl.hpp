...
#		endif
			...
			// operation
				...
				KERBAL_CONSTEXPR20
				void merge(avl_multimap<K, M, OtherKeyCompare, Allocator> & other);
...
#	endif // if __cplusplus >= 201703L
		...
		KERBAL_CONSTEXPR20
		bool operator==(
			const avl_multimap<K, M, KeyCompare, Allocator> & lhs,
			const avl_multimap<K, M, KeyCompare, Allocator2> & rhs
		)
		{
	...
	namespace algorithm
	{
		...
		KERBAL_CONSTEXPR20
		void swap(
			kerbal::container::avl_multimap<K, M, KeyCompare, Allocator> & a,
			kerbal::container::avl_multimap<K, M, KeyCompare, Allocator> & b
		)
