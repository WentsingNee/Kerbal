...
#ifndef KERBAL_CONTAINER_STATIC_FLAT_SET_STATIC_FLAT_SET_DECL_HPP
#define KERBAL_CONTAINER_STATIC_FLAT_SET_STATIC_FLAT_SET_DECL_HPP

#include <kerbal/container/static_flat_set/static_flat_set.fwd.hpp>
...
#		endif
			...
			public:
				...
				KERBAL_CONSTEXPR
				explicit
				static_flat_set(key_compare kc) :
					super(kc)
				{
				}
...
#		if __cplusplus >= 201103L
				...
				static_flat_set(const static_flat_set & src) = default;
				static_flat_set(static_flat_set && src) = default;
...
#		endif
			...
			public:
				...
				KERBAL_CONSTEXPR14
				void
				assign(const static_flat_set & src)
				{
...
#		endif
				...
				KERBAL_CONSTEXPR14
				static_flat_set &
				operator=(const static_flat_set & src)
				{
					this->assign(src);
					return *this;
				}
...
#endif // KERBAL_CONTAINER_STATIC_FLAT_SET_STATIC_FLAT_SET_DECL_HPP
