...
#		if __cplusplus >= 201103L
				...
				template <typename ... Args>
				KERBAL_CONSTEXPR14
				bool emplace_unique_is_delay_build(Args && ... args) KERBAL_NOEXCEPT;
...
#			define FBODY(i) \
 ...
 \
				KERBAL_OPT_PPEXPAND_WITH_COMMA_N(THEAD_NOT_EMPTY, EMPTY, TARGS_DECL, i) \
				bool emplace_unique_is_delay_build(KERBAL_OPT_PPEXPAND_WITH_COMMA_N(REMAINF, EMPTY, ARGS_DECL, i)) KERBAL_NOEXCEPT; \
