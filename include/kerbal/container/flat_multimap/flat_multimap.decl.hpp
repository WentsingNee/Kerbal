...
#		if __cplusplus >= 201103L
				...
				flat_multimap(const flat_multimap & src) = default;
				flat_multimap(flat_multimap && src) = default;
...
#		endif
			...
			public:
				...
				KERBAL_CONSTEXPR20
				void
				assign(const flat_multimap & src)
				{
...
#		endif
				...
				KERBAL_CONSTEXPR20
				flat_multimap &
				operator=(const flat_multimap & src)
				{
					this->assign(src);
					return *this;
				}
