	...
	namespace container
	{
		...
		namespace detail
		{
			...
			class vec_iter:
					...
					public kerbal::operators::addable<vec_iter<PointerType>, typename kerbal::iterator::iterator_traits<PointerType>::difference_type>, // it + N
					public kerbal::operators::addable_left<vec_iter<PointerType>, typename kerbal::iterator::iterator_traits<PointerType>::difference_type>,// N + it
					...
					public kerbal::operators::subtractable<vec_iter<PointerType>, typename kerbal::iterator::iterator_traits<PointerType>::difference_type> // it - N
			{
				...
				public:
					...
					KERBAL_CONSTEXPR
					friend bool operator==(const vec_iter & lhs, const vec_iter & rhs) KERBAL_NOEXCEPT
					{
			...
			class vec_kiter:
					...
					//random access iterator interface
					public kerbal::operators::addable<vec_kiter<PointerType>, typename kerbal::iterator::iterator_traits<PointerType>::difference_type>, // it + N
					public kerbal::operators::addable_left<vec_kiter<PointerType>, typename kerbal::iterator::iterator_traits<PointerType>::difference_type>,// N + it
					...
					public kerbal::operators::subtractable<vec_kiter<PointerType>, typename kerbal::iterator::iterator_traits<PointerType>::difference_type> // it - N
			{
				...
				public:
					...
					KERBAL_CONSTEXPR
					friend bool operator==(const vec_kiter & lhs, const vec_kiter & rhs) KERBAL_NOEXCEPT
					{
						return lhs.current == rhs.current;
					}
