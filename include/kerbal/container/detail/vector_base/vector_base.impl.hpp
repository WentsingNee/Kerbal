...
#		endif
			...
			KERBAL_CONSTEXPR20
			void vector_type_only<T, VoidPtr>::
...
#		endif
		...
		// element access
			...
			KERBAL_CONSTEXPR20
			typename
			vector_type_only<T, VoidPtr>::reference
			vector_type_only<T, VoidPtr>::
			at(size_type index)
			{
			...
			KERBAL_CONSTEXPR20
			typename
			vector_type_only<T, VoidPtr>::const_reference
			vector_type_only<T, VoidPtr>::
			...
			KERBAL_CONSTEXPR
			typename
			vector_type_only<T, VoidPtr>::const_pointer
			vector_type_only<T, VoidPtr>::
		...
		// iterator
			...
			KERBAL_CONSTEXPR14
			typename
			vector_type_only<T, VoidPtr>::iterator
			vector_type_only<T, VoidPtr>::
			...
			KERBAL_CONSTEXPR
			typename
			vector_type_only<T, VoidPtr>::const_iterator
			vector_type_only<T, VoidPtr>::
			...
			KERBAL_CONSTEXPR14
			typename
			vector_type_only<T, VoidPtr>::reverse_iterator
			vector_type_only<T, VoidPtr>::
			...
			KERBAL_CONSTEXPR14
			typename
			vector_type_only<T, VoidPtr>::const_reverse_iterator
			vector_type_only<T, VoidPtr>::
			...
			KERBAL_CONSTEXPR14
			typename
			vector_type_only<T, VoidPtr>::size_type
			vector_type_only<T, VoidPtr>::
...
#		endif
			...
			typename kerbal::type_traits::enable_if<
				kerbal::iterator::is_input_compatible_iterator<InputIterator>::value,
				typename vector_type_only<T, VoidPtr>::iterator
			>::type
			vector_type_only<T, VoidPtr>::
			k_insert_using_allocator(
				Allocator & alloc,
