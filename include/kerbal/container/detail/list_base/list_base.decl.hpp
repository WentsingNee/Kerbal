...
#				endif
					...
					KERBAL_CONSTEXPR20
					static
					const_iterator k_merge_sort_n(const_iterator first, difference_type len, BinaryPredict cmp, Project proj);
				...
				protected:
					...
					KERBAL_CONSTEXPR20
					static
					void k_merge_sort(const_iterator first, const_iterator last, BinaryPredict cmp, Project proj);
