...
#			else
					...
					template <typename NodeAllocator>
					static iterator emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos);

					template <typename NodeAllocator, typename Arg0>
					static iterator emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos, const Arg0& arg0);

					template <typename NodeAllocator, typename Arg0, typename Arg1>
					static iterator emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos, const Arg0& arg0, const Arg1& arg1);

					template <typename NodeAllocator, typename Arg0, typename Arg1, typename Arg2>
					static iterator emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos, const Arg0& arg0, const Arg1& arg1, const Arg2& arg2);
