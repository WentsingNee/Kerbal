...
namespace kerbal
{
	...
	namespace container
	{
		...
		namespace detail
		{
			...
			class avl_node_base: protected kerbal::container::detail::bst_node_base
			{
				private:
				...
				protected:
					...
					KERBAL_CONSTEXPR14
					static height_t height_of(const bst_head_node * p) KERBAL_NOEXCEPT
					{
						return height_of(as_avl_node_base(p));
					}
