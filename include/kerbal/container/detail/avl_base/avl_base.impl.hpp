...
#		endif
		...
		// insert
			...
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::iterator
			avl_type_only<Entity>::k_emplace_hook_node(Extract & e, KeyCompare & kc, node_base * p_node_base, UpCaster up_caster)
			{
				if (this->k_head.left == get_avl_vnull_node()) {
			...
			avl_type_only<Entity>::k_emplace_hook_node_unique(Extract & e, KeyCompare & kc, node_base * p_node_base, UpCaster up_caster)
			{
				if (this->k_head.left == get_avl_vnull_node()) {
					this->k_head.left = p_node_base;
					p_node_base->parent = &this->k_head;
...
#	endif
		...
		// prepare_insert
			...
			template <typename Extract, typename KeyCompare, typename UpCaster>
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::prepare_hook_node_context
			avl_type_only<Entity>::k_prepare_hook_node(Extract & e, KeyCompare & kc, node_base * p_node_base, UpCaster up_caster)
			{
				if (this->k_head.left == get_avl_vnull_node()) {
			...
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::iterator
			avl_type_only<Entity>::k_complete_hook_node(const prepare_hook_node_context & context, node_base * p_node_base) KERBAL_NOEXCEPT
			{
			...
			template <typename Extract, typename KeyCompare, typename UpCaster>
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::prepare_hook_node_unique_context
			avl_type_only<Entity>::k_prepare_hook_node_unique(Extract & e, KeyCompare & kc, node_base * p_node_base, UpCaster up_caster)
			{
				if (this->k_head.left == get_avl_vnull_node()) {
			...
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::iterator
			avl_type_only<Entity>::k_complete_hook_node_unique(const prepare_hook_node_unique_context & context, node_base * p_node_base) KERBAL_NOEXCEPT
			{
				if (context.status == 0) {
					*(context.p_insert_pos) = p_node_base;
					p_node_base->parent = &this->k_head;
			...
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::iterator
			avl_type_only<Entity>::k_complete_hook_node_duplicated(const prepare_hook_node_context & context) KERBAL_NOEXCEPT
			{
			...
			KERBAL_CONSTEXPR14
			typename avl_type_only<Entity>::iterator
			avl_type_only<Entity>::k_complete_hook_node_duplicated(const prepare_hook_node_unique_context & context) KERBAL_NOEXCEPT
			{
				return iterator(context.p_pos);
			}
