...
#		endif
				...
				friend
				bool operator==(
					const static_flat_map<Key2, Value2, N1, KeyCompare2> & lhs,
					const static_flat_map<Key2, Value2, N2, KeyCompare2> & rhs
				);
		...
		KERBAL_CONSTEXPR14
		bool operator==(
			const static_flat_map<Key, Value, M, KeyCompare> & lhs,
