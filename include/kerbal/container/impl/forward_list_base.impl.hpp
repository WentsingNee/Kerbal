...
#	if __cplusplus >= 201103L
			...
			template <typename Tp>
			KERBAL_CONSTEXPR14
			void fl_allocator_unrelated<Tp>::_K_move_cnstrct_ua_ae(fl_allocator_unrelated && src) KERBAL_NOEXCEPT
			{
			...
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_move_cnstrct_ua_ane(NodeAllocator & alloc, NodeAllocator && /*src_alloc*/, fl_allocator_unrelated && src)
			{
				if (src.empty()) {
					return;
				}
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_move_cnstrct_ua_helper(NodeAllocator & alloc, NodeAllocator && src_alloc, fl_allocator_unrelated && src,
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR14
			fl_allocator_unrelated<Tp>::fl_allocator_unrelated(NodeAllocator & alloc, NodeAllocator && src_alloc, fl_allocator_unrelated && src)
...
#	endif
			...
			{
				this->_K_consecutive_destroy_node(alloc, this->head_node.next, NULL);
			}
		...
		// assign
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_cpy_ass_ua_impl(NodeAllocator & alloc, const NodeAllocator & src_alloc, const fl_allocator_unrelated & src, CPYASS_VER_NOT_PROPAGATE)
			{
				if (alloc != src_alloc) {
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_cpy_ass_ua_impl(NodeAllocator & alloc, const NodeAllocator & src_alloc, const fl_allocator_unrelated & src, CPYASS_VER_PROPAGATE)
			{
				if (alloc != src_alloc) {
					this->destroy_using_allocator(alloc);
					this->head_node.next = NULL;
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_cpy_ass_ua_impl(NodeAllocator & alloc, const NodeAllocator & /*src_alloc*/, const fl_allocator_unrelated & src, CPYASS_VER_ALWAYS_EQUAL)
			{
				this->assign_using_allocator(alloc, src.cbegin(), src.cend());
			}
...
#		if __cplusplus >= 201103L
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_mov_ass_ua_ae(NodeAllocator & alloc, fl_allocator_unrelated && src) KERBAL_NOEXCEPT
			{
				this->destroy_using_allocator(alloc);
				this->head_node.next = NULL;
				fl_type_unrelated::_K_swap_type_unrelated(static_cast<fl_type_unrelated &>(src), static_cast<fl_type_unrelated &>(*this));
			}
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_mov_ass_ua_ane(NodeAllocator & alloc, fl_allocator_unrelated && src)
			{
			...
			template <typename NodeAllocator>
			KERBAL_CONSTEXPR20
			void fl_allocator_unrelated<Tp>::_K_mov_ass_ua_impl(NodeAllocator & alloc, NodeAllocator && src_alloc, fl_allocator_unrelated && src,
...
#		else
			...
			template <typename NodeAllocator>
			typename fl_allocator_unrelated<Tp>::reference
			fl_allocator_unrelated<Tp>::emplace_front_using_allocator(NodeAllocator & alloc)
			{
			...
			typename fl_allocator_unrelated<Tp>::reference
			fl_allocator_unrelated<Tp>::emplace_front_using_allocator(NodeAllocator & alloc, const Arg0& arg0)
			{
			...
			typename fl_allocator_unrelated<Tp>::reference
			fl_allocator_unrelated<Tp>::emplace_front_using_allocator(NodeAllocator & alloc, const Arg0& arg0, const Arg1& arg1)
			{
			...
			typename fl_allocator_unrelated<Tp>::reference
			fl_allocator_unrelated<Tp>::emplace_front_using_allocator(NodeAllocator & alloc, const Arg0& arg0, const Arg1& arg1, const Arg2& arg2)
			{
...
#		if __cplusplus >= 201103L
			...
			{
				node *p = _K_build_new_node(alloc, kerbal::utility::forward<Args>(args)...);
				fl_type_unrelated::_K_hook_node_after(pos, p);
				return iterator(p);
			}
...
#		else
			...
			template <typename NodeAllocator>
			typename fl_allocator_unrelated<Tp>::iterator
			fl_allocator_unrelated<Tp>::emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos)
			{
				node *p = _K_build_new_node(alloc);
				fl_type_unrelated::_K_hook_node_after(pos, p);
				return iterator(p);
			...
			template <typename NodeAllocator, typename Arg0>
			typename fl_allocator_unrelated<Tp>::iterator
			fl_allocator_unrelated<Tp>::emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos, const Arg0& arg0)
			{
				node *p = _K_build_new_node(alloc, arg0);
				fl_type_unrelated::_K_hook_node_after(pos, p);
				return iterator(p);
			...
			template <typename NodeAllocator, typename Arg0, typename Arg1>
			typename fl_allocator_unrelated<Tp>::iterator
			fl_allocator_unrelated<Tp>::emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos, const Arg0& arg0, const Arg1& arg1)
			{
				node *p = _K_build_new_node(alloc, arg0, arg1);
				fl_type_unrelated::_K_hook_node_after(pos, p);
				return iterator(p);
			...
			template <typename NodeAllocator, typename Arg0, typename Arg1, typename Arg2>
			typename fl_allocator_unrelated<Tp>::iterator
			fl_allocator_unrelated<Tp>::emplace_after_using_allocator(NodeAllocator & alloc, const_iterator pos, const Arg0& arg0, const Arg1& arg1, const Arg2& arg2)
			{
				node *p = _K_build_new_node(alloc, arg0, arg1, arg2);
				fl_type_unrelated::_K_hook_node_after(pos, p);
				return iterator(p);
...
#		endif
		...
		// erase
			...
			fl_allocator_unrelated<Tp>::erase_after_using_allocator(NodeAllocator & alloc, const_iterator pos)
			{
				...
				node_base * p = fl_type_unrelated::_K_unhook_node_after(pos_mut);
			...
			fl_allocator_unrelated<Tp>::erase_after_using_allocator(NodeAllocator & alloc, const_iterator first, const_iterator last)
			{
				...
				if (first != last) {
					node_base * first = fl_type_unrelated::_K_unhook_node_after(first_mut, last_mut);
				...
				while (it_other != cend) {
					if (it_this != cend) {
						if (cmp(*it_other, *it_this)) {
							fl_type_unrelated::_K_hook_node_after(it_this_before, it_other++.cast_to_mutable().current);
							++it_this_before;
						} else {
...
#		endif
			...
			fl_allocator_unrelated<Tp>::_K_merge_sort_merge_after_impl(const_iterator before_first, const_iterator before_mid, const_iterator before_last, BinaryPredict cmp, MSM_VER_NOTHROW)
			{
				...
				while (i != mid) {
					if (j != last) {
						if (cmp(*j, *i)) {
							fl_type_unrelated::_K_hook_node_after(before_i, j++.cast_to_mutable().current);
							++before_i;
						} else {
							before_i = i;
							++i;
				...
				if (first != last) {
					...
					while (forward != last) {
						if (equal_to(*first, *forward)) {
							++forward;
							_K_destroy_node(alloc, fl_type_unrelated::_K_unhook_node_after(first));
							++cnt;
						} else {
							first = forward;
							++forward;
