...
#		endif
			...
			template <typename BinaryPredict>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_difference(list_allocator_unrelated & lto, list_allocator_unrelated & l1, const list_allocator_unrelated & l2, BinaryPredict cmp)
			{
			...
			template <typename Tp>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_difference(list_allocator_unrelated & lto, list_allocator_unrelated & l1, const list_allocator_unrelated & l2)
			{
				list_allocator_unrelated::_K_set_difference(lto, l1, l2, std::less<value_type>());
			}

			template <typename Tp>
			template <typename BinaryPredict>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_intersection(list_allocator_unrelated & lto, list_allocator_unrelated & l1, list_allocator_unrelated & l2, BinaryPredict cmp)
			{
				const_iterator it1(l1.cbegin());
				const_iterator it2(l2.cbegin());
				const_iterator const end1(l1.cend());
			...
			template <typename Tp>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_intersection(list_allocator_unrelated & lto, list_allocator_unrelated & l1, list_allocator_unrelated & l2)
			{
				list_allocator_unrelated::_K_set_intersection(lto, l1, l2, std::less<value_type>());
			}

			template <typename Tp>
			template <typename BinaryPredict>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_symmetric_difference(list_allocator_unrelated & lto, list_allocator_unrelated & l1, list_allocator_unrelated & l2, BinaryPredict cmp)
			{
				const_iterator it1(l1.cbegin());
				const_iterator it2(l2.cbegin());
				const_iterator const end1(l1.cend());
			...
			template <typename Tp>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_symmetric_difference(list_allocator_unrelated & lto, list_allocator_unrelated & l1, list_allocator_unrelated & l2)
			{
				list_allocator_unrelated::_K_set_symmetric_difference(lto, l1, l2, std::less<value_type>());
			}

			template <typename Tp>
			template <typename BinaryPredict>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_union(list_allocator_unrelated & lto, list_allocator_unrelated & l1, list_allocator_unrelated & l2, BinaryPredict cmp)
			{
				const_iterator it1(l1.cbegin());
				const_iterator it2(l2.cbegin());
				const_iterator const end1(l1.cend());
			...
			template <typename Tp>
			KERBAL_CONSTEXPR20
			void list_allocator_unrelated<Tp>::_K_set_union(list_allocator_unrelated & lto, list_allocator_unrelated & l1, list_allocator_unrelated & l2)
			{
				list_allocator_unrelated::_K_set_union(lto, l1, l2, std::less<value_type>());
			}
