...
namespace kerbal
{
	...
	namespace container
	{
		...
		{
			protected:
				typedef detail::rb_ordered_typedef_helper<Entity, Extract, KeyCompare, Allocator>		rb_ordered_typedef_helper;
...
#		endif
				...
				KERBAL_CONSTEXPR20
				explicit
				rb_ordered(const Allocator & alloc) /*KERBAL_CONDITIONAL_NOEXCEPT(
			...
			// construct with iterators range
				...
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const Allocator & alloc);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const KeyCompare & key_comp);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const KeyCompare & key_comp, const Allocator & alloc);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const Extract & e);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const Extract & e, const Allocator & alloc);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const Extract & e, const KeyCompare & key_comp);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(InputIterator first, InputIterator last, const Extract & e, const KeyCompare & key_comp, const Allocator & alloc);
			...
			// construct with iterators range (unique)
				...
				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const Allocator & alloc);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const KeyCompare & key_comp);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const KeyCompare & key_comp, const Allocator & alloc);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const Extract & e);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const Extract & e, const Allocator & alloc);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const Extract & e, const KeyCompare & key_comp);

				template <typename InputIterator>
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, InputIterator first, InputIterator last, const Extract & e, const KeyCompare & key_comp, const Allocator & alloc);
...
#		if __cplusplus >= 201103L
			...
			// construct with initializer_list
				...
				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const Allocator & alloc);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const KeyCompare & key_comp);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const KeyCompare & key_comp, const Allocator & alloc);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const Extract & e);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const Extract & e, const Allocator & alloc);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const Extract & e, const KeyCompare & key_comp);

				KERBAL_CONSTEXPR20
				rb_ordered(std::initializer_list<value_type> ilist, const Extract & e, const KeyCompare & key_comp, const Allocator & alloc);
			...
			// construct with initializer_list (unique)
				...
				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const Allocator & alloc);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const KeyCompare & key_comp);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const KeyCompare & key_comp, const Allocator & alloc);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const Extract & e);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const Extract & e, const Allocator & alloc);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const Extract & e, const KeyCompare & key_comp);

				KERBAL_CONSTEXPR20
				rb_ordered(kerbal::container::unique_tag_t unique_tag, std::initializer_list<value_type> ilist, const Extract & e, const KeyCompare & key_comp, const Allocator & alloc);
...
#		else
			...
			// construct with assign_list
				...
				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const Allocator & alloc);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const KeyCompare & key_comp);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const KeyCompare & key_comp, const Allocator & alloc);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const Extract & e);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const Extract & e, const Allocator & alloc);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const Extract & e, const KeyCompare & key_comp);

				template <typename U>
				rb_ordered(const kerbal::assign::assign_list<U> & ilist, const Extract & e, const KeyCompare & key_comp, const Allocator & alloc);
			...
			// construct with assign_list (unique)
				...
				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const Allocator & alloc);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const KeyCompare & key_comp);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const KeyCompare & key_comp, const Allocator & alloc);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const Extract & e);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const Extract & e, const Allocator & alloc);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const Extract & e, const KeyCompare & key_comp);

				template <typename U>
				rb_ordered(kerbal::container::unique_tag_t unique_tag, const kerbal::assign::assign_list<U> & ilist, const Extract & e, const KeyCompare & key_comp, const Allocator & alloc);
...
#		endif
			...
			protected:
				...
				struct enable_if_transparent_lookup :
						rb_type_only::template enable_if_transparent_lookup<Key, Extract, KeyCompare, Result>
				{
				};
...
#	if __cplusplus >= 201703L
		...
		rb_ordered(InputIterator, InputIterator, const Extract &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract>;
		...
		>
		rb_ordered(InputIterator, InputIterator, const Extract &, const KeyCompare &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract, KeyCompare>;
		...
		>
		rb_ordered(InputIterator, InputIterator, const Extract &, const Allocator &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract, kerbal::compare::binary_type_less<void, void>, Allocator>;

		template <typename InputIterator, typename Extract, typename KeyCompare, typename Allocator,
				typename = typename kerbal::type_traits::enable_if<kerbal::memory::is_allocator<Allocator>::value>::type
		>
		rb_ordered(InputIterator, InputIterator, const Extract &, const KeyCompare &, const Allocator &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract, KeyCompare, Allocator>;


		template <typename InputIterator, typename Extract>
		rb_ordered(kerbal::container::unique_tag_t, InputIterator, InputIterator, const Extract &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract>;

		template <typename InputIterator, typename Extract, typename KeyCompare,
				typename = typename kerbal::type_traits::enable_if<!kerbal::memory::is_allocator<KeyCompare>::value>::type
		>
		rb_ordered(kerbal::container::unique_tag_t, InputIterator, InputIterator, const Extract &, const KeyCompare &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract, KeyCompare>;

		template <typename InputIterator, typename Extract, typename Allocator,
				typename = typename kerbal::type_traits::enable_if<kerbal::memory::is_allocator<Allocator>::value>::type
		>
		rb_ordered(kerbal::container::unique_tag_t, InputIterator, InputIterator, const Extract &, const Allocator &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract, kerbal::compare::binary_type_less<void, void>, Allocator>;

		template <typename InputIterator, typename Extract, typename KeyCompare, typename Allocator,
				typename = typename kerbal::type_traits::enable_if<kerbal::memory::is_allocator<Allocator>::value>::type
		>
		rb_ordered(kerbal::container::unique_tag_t, InputIterator, InputIterator, const Extract &, const KeyCompare &, const Allocator &)
		-> rb_ordered<typename kerbal::iterator::iterator_traits<InputIterator>::value_type, Extract, KeyCompare, Allocator>;


		template <typename Entity, typename Extract>
		rb_ordered(std::initializer_list<Entity>, const Extract &)
		-> rb_ordered<Entity, Extract>;

		template <typename Entity, typename Extract, typename KeyCompare,
				typename = typename kerbal::type_traits::enable_if<!kerbal::memory::is_allocator<KeyCompare>::value>::type
		>
		rb_ordered(std::initializer_list<Entity>, const Extract &, const KeyCompare &)
		-> rb_ordered<Entity, Extract, KeyCompare>;

		template <typename Entity, typename Extract, typename Allocator,
				typename = typename kerbal::type_traits::enable_if<kerbal::memory::is_allocator<Allocator>::value>::type>
		rb_ordered(std::initializer_list<Entity>, const Extract &, const Allocator &)
		-> rb_ordered<Entity, Extract, kerbal::compare::binary_type_less<void, void>, Allocator>;

		template <typename Entity, typename Extract, typename KeyCompare, typename Allocator,
				typename = typename kerbal::type_traits::enable_if<kerbal::memory::is_allocator<Allocator>::value>::type
		>
		rb_ordered(std::initializer_list<Entity>, const Extract &, const KeyCompare &, const Allocator &)
...
#	endif // if __cplusplus >= 201703L
		...
		KERBAL_CONSTEXPR20
		bool operator==(const rb_ordered<Entity, Extract, KeyCompare, Allocator> & lhs, const rb_ordered<Entity, Extract, KeyCompare, Allocator2> & rhs)
		{
	...
	namespace algorithm
	{
		...
		template <typename Entity, typename Extract, typename KeyCompare, typename Allocator>
		KERBAL_CONSTEXPR20
		void swap(kerbal::container::rb_ordered<Entity, Extract, KeyCompare, Allocator> & a, kerbal::container::rb_ordered<Entity, Extract, KeyCompare, Allocator> & b)
