...
#	endif
		...
		{
			this->rb_type_only::k_assign_unique_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				first, last
			);
		}
...
#	endif
		...
		KERBAL_CONSTEXPR20
		typename
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::const_iterator
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::
		find(const key_type & key) const
		{
			return this->rb_type_only::k_find(this->extract(), this->key_comp(), key);
		}

		template <typename Entity, typename Extract, typename KeyCompare, typename Allocator>
		KERBAL_CONSTEXPR20
		typename
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::iterator
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::
		...
		KERBAL_CONSTEXPR20
		typename
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::template enable_if_transparent_lookup<
			Key,
		...
		{
			return this->rb_type_only::k_lower_bound(this->extract(), this->key_comp(), key);
		}
		...
		{
			return this->rb_type_only::k_upper_bound(this->extract(), this->key_comp(), key);
		}
		...
		{
			return this->rb_type_only::k_equal_range(this->extract(), this->key_comp(), key);
		}
		...
		{
			return this->rb_type_only::k_contains(this->extract(), this->key_comp(), key);
		}
...
#	if __cplusplus >= 201103L
		...
		emplace(Args && ... args)
		{
			return this->rb_type_only::k_emplace_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
		...
		KERBAL_CONSTEXPR20
		typename
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::unique_insert_r
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::
		emplace_unique(Args && ... args)
		{
			return this->rb_type_only::k_emplace_unique_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				kerbal::utility::forward<Args>(args)...
			);
		}
...
#	endif
		...
		{
			return this->rb_type_only::k_insert_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				src
			);
		}
		...
		{
			return this->rb_type_only::k_insert_unique_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				src
			);
		}
...
#	endif
		...
		{
			this->rb_type_only::k_insert_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				first, last
			);
		}
		...
		{
			this->rb_type_only::k_insert_unique_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				first, last
			);
		}
...
#	endif
		...
		{
			return this->rb_type_only::k_erase_not_end_using_allocator_unsafe(
				this->alloc(),
				pos
			);
		}
		...
		{
			return this->rb_type_only::k_erase_using_allocator(
				this->alloc(),
				pos
			);
		}
		...
		KERBAL_CONSTEXPR20
		typename
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::size_type
		rb_ordered<Entity, Extract, KeyCompare, Allocator>::
		...
		{
			this->rb_type_only::k_clear_using_allocator(this->alloc());
		}
...
#	if __cplusplus >= 201103L
		...
		{
			return this->rb_type_only::k_replace_emplace_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				replace,
				kerbal::utility::forward<Args>(args)...
			);
		...
		{
			return this->rb_type_only::k_replace_emplace_unique_using_allocator(
				this->alloc(), this->extract(), this->key_comp(),
				replace,
				kerbal::utility::forward<Args>(args)...
			);
...
#	endif
		...
		swap(rb_ordered & other)
		{
			...
			rb_type_unrelated::k_swap(
				static_cast<rb_type_unrelated &>(*this),
