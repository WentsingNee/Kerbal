...
#		if KERBAL_HAS_CONCEPTS_SUPPORT
			...
			concept vector_emplace_able = kerbal::concepts::constructible_from<Tp, Args...>;

			template <typename Tp, typename ... Args>
			concept vector_emplace_back_able = kerbal::concepts::constructible_from<Tp, Args...>;

#		endif


		KERBAL_CONTAINER_VECTOR_THEAD(Tp, Allocator)
		class vector:
...
#		if __cplusplus >= 201103L
				...
				template <typename ... Args>
						KERBAL_REQUIRES((vector_emplace_able<Tp, Args...>))
				KERBAL_CONSTEXPR20
...
#		if __cplusplus >= 201103L
				...
				template <typename ... Args>
						KERBAL_REQUIRES((vector_emplace_back_able<Tp, Args...>))
				KERBAL_CONSTEXPR20
