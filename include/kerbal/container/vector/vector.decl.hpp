...
namespace kerbal
{
	...
	namespace container
	{
				...
				protected kerbal::container::detail::vector_type_only<typename kerbal::memory::allocator_traits<Allocator>::pointer>
		{
			...
			public:
				typedef typename kerbal::memory::allocator_traits<Allocator>::pointer				pointer;
				typedef typename kerbal::memory::allocator_traits<Allocator>::const_pointer			const_pointer;
				typedef kerbal::container::detail::vector_type_only<pointer>			vector_type_only;
...
#		else
				...
				template <typename U>
				vector(const kerbal::assign::assign_list<U> & ilist);

				vector(const kerbal::assign::assign_list<void> & ilist, const Allocator & allocator);

				template <typename U>
				vector(const kerbal::assign::assign_list<U> & ilist, const Allocator & allocator);
