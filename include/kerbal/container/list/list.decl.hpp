...
#		if __cplusplus >= 201103L
				...
				KERBAL_CONSTEXPR20
				list(std::initializer_list<value_type> ilist, const Allocator & alloc);
...
#	endif
	...
	namespace algorithm
	{
		...
		KERBAL_CONSTEXPR20
		void swap(
			kerbal::container::list<T, Allocator> & a,
			kerbal::container::list<T, Allocator> & b
		)
