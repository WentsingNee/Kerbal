...
#	endif
		...
		template <typename T, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<T, N>::k_assign_unsafe_n_val(size_type new_size, const_reference val, ASSIGN_UNSAFE_N_VAL_VER_DEFAULT)
		{
		...
		template <typename T, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<T, N>::k_assign_unsafe_n_val(size_type new_size, const_reference val, ASSIGN_UNSAFE_N_VAL_VER_TRIVIALLY_DESTRUCTIBLE)
		{
			size_type previous_size = this->size();
