...
#	endif
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_directly(size_type new_size, const_reference val)
		{
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_larger_size(size_type new_size, const_reference val, kerbal::type_traits::false_type)
		{
			/*
			 * a a a x x x x x
			 * b b b b b b x x
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_larger_size(size_type new_size, const_reference val, kerbal::type_traits::true_type)
		{
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_larger_size(size_type new_size, const_reference val)
		{
...
#		endif
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_smaller_size(size_type new_size, const_reference val, kerbal::type_traits::false_type)
		{
			/*
			 * a a a a a a x x
			 * b b b x x x x x
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_smaller_size(size_type new_size, const_reference val, kerbal::type_traits::true_type)
		{
			this->k_assign_unsafe_n_val_directly(new_size, val);
		}
		...
		template <typename Tp, std::size_t N>
		KERBAL_CONSTEXPR14
		void static_vector<Tp, N>::k_assign_unsafe_n_val_smaller_size(size_type new_size, const_reference val)
		{
