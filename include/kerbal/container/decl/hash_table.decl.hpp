...
#ifndef KERBAL_CONTAINER_DECL_HASH_TABLE_DECL_HPP
#define KERBAL_CONTAINER_DECL_HASH_TABLE_DECL_HPP
...
namespace kerbal
{
	...
	namespace container
	{
		...
		namespace detail
		{
			...
			{
					typedef typename kerbal::container::detail::hash_cache_policy<Entity, Hash>::type			hash_cache_policy;
					typedef kerbal::container::detail::hash_table_base<Entity, Extract, hash_cache_policy>		hash_table_base;

					typedef typename hash_table_base::hash_table_node			hash_table_node;
					...
					typedef typename node_allocator_br_traits::template rebind_alloc<hash_table_node>::other	node_allocator_type;
					typedef typename node_allocator_br_traits::template rebind_traits<hash_table_node>::other	node_allocator_traits;
					typedef kerbal::container::detail::container_rebind_allocator_overload<
							NodeAllocatorBR, hash_table_node
				...
				>::hash_table_base
		{
			private:
				...
				typedef typename hash_table_typedef_helper::hash_table_node						hash_table_node;
...
#		endif
			...
			// Hash policy
				...
				{
					this->hash_table_base::reserve(this->hash(), this->bucket_alloc(), new_size);
				}
...
#endif // KERBAL_CONTAINER_DECL_HASH_TABLE_DECL_HPP
