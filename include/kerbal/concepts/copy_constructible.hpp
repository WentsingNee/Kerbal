...
namespace kerbal
{
	...
	namespace concepts
	{
		...
		KERBAL_CONCEPT copy_constructible =
				...
				kerbal::concepts::constructible_from<T, T&> && kerbal::concepts::convertible_to<T&, T> &&
				kerbal::concepts::constructible_from<T, const T&> && kerbal::concepts::convertible_to<const T&, T> &&
				kerbal::concepts::constructible_from<T, const T> && kerbal::concepts::convertible_to<const T, T>
		;
