/**
 * @file       member_compress_helper_impl.not_compressed.part.hpp
 * @brief
 * @date       2020-09-20
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_UTILITY_MEMBER_COMPRESS_HELPER_DETAIL_MEMBER_COMPRESS_HELPER_IMPL_MEMBER_COMPRESS_HELPER_IMPL_NOT_COMPRESSED_PART_HPP
#define KERBAL_UTILITY_MEMBER_COMPRESS_HELPER_DETAIL_MEMBER_COMPRESS_HELPER_IMPL_MEMBER_COMPRESS_HELPER_IMPL_NOT_COMPRESSED_PART_HPP
...
#endif // KERBAL_UTILITY_MEMBER_COMPRESS_HELPER_DETAIL_MEMBER_COMPRESS_HELPER_IMPL_MEMBER_COMPRESS_HELPER_IMPL_NOT_COMPRESSED_PART_HPP
