...
namespace kerbal
{
	...
	namespace assign
	{
		...
		namespace detail
		{
			...
			template <typename InputIterator, typename OutputIterator>
			KERBAL_CONSTEXPR14
			void k_copy(InputIterator first, InputIterator last, OutputIterator out, kerbal::type_traits::false_type)
			{
				while (first != last) {
			...
			template <typename InputIterator, typename OutputIterator>
			KERBAL_CONSTEXPR14
			void k_copy(InputIterator first, InputIterator last, OutputIterator out, kerbal::type_traits::true_type)
			{
			...
			void copy(InputIterator first, InputIterator last, OutputIterator out)
			{
				...
				KERBAL_STATIC_ASSERT(input_extent::value == output_extent::value, "input and output must have same length");
