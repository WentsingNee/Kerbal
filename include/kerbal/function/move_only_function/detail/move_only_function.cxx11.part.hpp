/**
 * @file       move_only_function.cxx11.part.hpp
 * @brief
 * @date       2023-12-11
 * @author     Peter
 * @copyright
...
#ifndef KERBAL_FUNCTION_MOVE_ONLY_FUNCTION_DETAIL_MOVE_ONLY_FUNCTION_CXX11_PART_HPP
#define KERBAL_FUNCTION_MOVE_ONLY_FUNCTION_DETAIL_MOVE_ONLY_FUNCTION_CXX11_PART_HPP

#include <kerbal/function/move_only_function/move_only_function.fwd.hpp>
...
#define KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_DISABLE 0
#define KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_POINTER 1
#define KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_FUNCTION 2

#ifndef KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY

#	if !defined(__cpp_rtti) && !defined(__GXX_RTTI)
#		define KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_DISABLE
#	elif KERBAL_COMPILER_ID == KERBAL_COMPILER_ID_MSVC
#		define KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_FUNCTION
#	else
#		define KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_POINTER
#	endif

#endif

#if KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY != KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_DISABLE
#	include <typeinfo>
#endif
...
#	if KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY == KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_POINTER
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_TYPEDEF	typedef const std::type_info * type_info_entry_type
#	elif KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY == KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_FUNCTION
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_TYPEDEF	typedef const std::type_info & (*type_info_entry_type)() KERBAL_NOEXCEPT17
#	else
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_TYPEDEF
#	endif

#	if KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY != KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_DISABLE
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_MEMDEF	type_info_entry_type				type_info
#	else
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_MEMDEF
#	endif

#	if KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY != KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_DISABLE
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_CONSTRUCTOR_ARG	, type_info_entry_type					type_info
#	else
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_CONSTRUCTOR_ARG
#	endif

#	if KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY != KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_DISABLE
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_ILIST	, type_info(type_info)
#	else
#		define KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_ILIST
#	endif


			template <std::size_t Size, std::size_t Align, typename Allocator, typename Ret, typename ... TArgs>
			struct move_only_function_manager_table
			{
					...
					KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_TYPEDEF;
					...
					KERBAL_MOVE_ONLY_FUNCTION_MANAGER_TABLE_TYPE_MEMDEF;
...
#	elif KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY == KERBAL_MOVE_ONLY_FUNCTION_TYPE_POLICY_POINTER
...
#	undef TYPE_INFO_ENTRY
				...
				private kerbal::utility::member_compress_helper<Allocator>
		{
			private:
				...
				KERBAL_CONSTEXPR20
				friend
				T* function_cast(basic_move_only_function<Ret2(TArgs2...), Size2, Align2, Allocator2> * operand) KERBAL_NOEXCEPT;

				template <typename T, std::size_t Size2, std::size_t Align2, typename Allocator2, typename Ret2, typename ... TArgs2>
				KERBAL_CONSTEXPR20
				friend
				const T* function_cast(const basic_move_only_function<Ret2(TArgs2...), Size2, Align2, Allocator2> * operand) KERBAL_NOEXCEPT;
				...
				typedef const detail::move_only_function_manager_table<Size, Align, Allocator, Ret, TArgs...>		manager_table;
			...
			private:
				...
				{
					return &detail::move_only_function_manager_collection<T, Size, Align, Allocator, Ret, TArgs...>::mtable;
				}
			...
			public:
				...
				basic_move_only_function(const basic_move_only_function & src) = delete;
...
#	endif
				...
				KERBAL_CONSTEXPR20
				void assign(const basic_move_only_function & src) = delete;

				KERBAL_CONSTEXPR20
				void assign(basic_move_only_function && src) KERBAL_NOEXCEPT
				{
					if (this == &src) {
						return;
					}
				...
				KERBAL_CONSTEXPR20
				void swap(basic_move_only_function & with) KERBAL_NOEXCEPT
				{
...
#endif // KERBAL_FUNCTION_MOVE_ONLY_FUNCTION_DETAIL_MOVE_ONLY_FUNCTION_CXX11_PART_HPP
