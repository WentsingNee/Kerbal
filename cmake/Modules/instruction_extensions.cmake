...
function(__kerbal_check_supports_neon_flags_and_cache)
    set(ie "neon")
    set(flags -march=armv8-a -mfpu=neon)
    kerbal_check_supports_ie_flags(${ie} support ${flags})
    if (support)
    ...
    message(STATUS "-march=armv8-a -mfpu=neon doesn't support, re-trying: -march=armv8-a+simd")
    kerbal_check_supports_ie_flags(${ie} support  ${flags})
    if (support)
        __kerbal_cache_result_of_supports_ie_flags(${ie} True ${flags})
        return()
