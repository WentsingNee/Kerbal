		...
		namespace complex
		{
			class Complex
			{
				public:
					...
					friend const Complex operator/(const Complex &a, const Complex &b) throw (std::invalid_argument);
					friend const Complex operator/(const Complex &a, double b) throw (std::invalid_argument);
					friend const Complex operator/(double a, const Complex &b) throw (std::invalid_argument);
