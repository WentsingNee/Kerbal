	...
	namespace math
	{
		...
		class Matrix: public Array_2d<double>
		{
			public:
				...
				{
					/** @brief 输出直角 */
					Fr_RtMatrix, //!< Fr_RtMatrix

					/** @brief 输出圆角 */
					Fr_RdMatrix, //!< Fr_RdMatrix
				...
				void save(const std::string &file_name) const throw (std::runtime_error);
				static const Matrix load_from(const std::string &file_name);
