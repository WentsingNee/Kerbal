#ifndef _BALL_SPHERICAL_H_
#define _BALL_SPHERICAL_H_
...
class Spherical
{
	public:
		...
		Spherical(double longitude, double latitude, double height = 0.0, string comment = "")
		{
